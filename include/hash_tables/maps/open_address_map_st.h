...
/*!
 * \file
 * \brief Definition of open_address_map_st class.
 */
#pragma once
...
/*!
 * \brief Class to save key-value relations in a hash table using open
 * addressing.
 *
...
public:
     ...
     */
    explicit open_address_map_st(size_type min_num_nodes,
     ...
     */
    open_address_map_st(const open_address_map_st&) = default;

    /*!
     * \brief Move constructor.
     */
    open_address_map_st(open_address_map_st&&)
     ...
     * \return This.
     */
    auto operator=(const open_address_map_st&) -> open_address_map_st&
#ifndef HASH_TABLES_DOCUMENTATION
        = default
#endif
        ;
     ...
     * \return This.
     */
    auto operator=(open_address_map_st&&)
#ifndef HASH_TABLES_DOCUMENTATION
     ...
     * \brief Destructor.
     */
    ~open_address_map_st() noexcept = default;
